...
namespace TrashCollector.Data.Migrations
{
    ...
    [Migration("20200319190003_AddedSeveralItems")]
    partial class AddedSeveralItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrashCollector.Models.CollectionDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TrashCollector.Models.Customer", b =>
                {
                    b.HasOne("TrashCollector.Models.CollectionDay", "Day")
                        .WithMany()
                        .HasForeignKey("CollectionDayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
